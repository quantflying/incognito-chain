...
func buildInstructionsForIssuingETHReq(
	contentStr string,
	shardID byte,
	metaType int,
	ac *metadata.AccumulatedValues,
	...
	logMap, err := metadata.PickAndParseLogMapFromReceipt(ethReceipt, blockchain.GetChainParams().EthContractAddressStr)
	if err != nil {
