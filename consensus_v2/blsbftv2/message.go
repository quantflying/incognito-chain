...
func MakeBFTProposeMsg(proposeCtn *BFTPropose, chainKey string, ts uint64) (wire.Message, error) {
...
func MakeBFTVoteMsg(vote *BFTVote, chainKey string, ts uint64) (wire.Message, error) {
